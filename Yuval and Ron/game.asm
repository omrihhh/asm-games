...
spark	db 't', 't', 't', 0fh, 't', 't', 't', 'n'
		db 't', 't', 0fh, 0fh, 0fh, 't', 't', 'n'
		db 0fh, 0fh, 't', 0fh, 't', 0fh, 0fh, 'n'
		db 't', 't', 't', 0fh, 't', 't', 't', 'n'
		db '$'
...
proc BulletCollision
	...
	call GetLine
	shl bx, 1
	add bx, offset line_lives
	sub [word bx], 1
	cmp [word bx], 0
	jne enemy_live_is_greater_then_0
		sub bx, offset line_lives
	...
	tile_y:
		...
		tile_x:
			...
			jne not_drawing_main_character
				...
				jne already_caught_collision_with_enemy
					cmp al, 04h
					...
					jne no_collision_detected2
						call EnemyCollision
				already_caught_collision_with_enemy:
...
proc MainLoop ; Main loop of the game.
	...
	main_loop:
		...
		jle no_new_high_score
			...
			; increase bonus and enemy lives with score:
